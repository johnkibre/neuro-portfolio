...
- **3D Exploded Cube**: Three.js visualization showing:
  ...
  - Backend Layer (Purple wireframe)
...
- Hardware/ECE (C/C++, Arduino, Circuit Design)
- AI/ML (Python, TensorFlow, OCR)
...
- Electric Cyan (#64ffda) - Software elements
- Hardware Amber (#ffb700) - Hardware elements
- Silicon Purple (#8a2be2) - Backend/API
